...
OUTPUT_SCENE_PATH = "../unitree_robots/" + ROBOT + "/scene_terrain1.xml"
...
if __name__ == "__main__":
    ...
    # Box obstacle
    tg.AddBox(position=[1.5, 0.0, 0.0], euler=[0, 0, 0.0], size=[1, 1.5, 0.1])
    
    # Geometry obstacle
    # geo_type supports "plane", "sphere", "capsule", "ellipsoid", "cylinder", "box"
    tg.AddGeometry(position=[1.5, 0.0, 0.1], euler=[0, 0, 0.0], size=[1.0,0.1,0.1],geo_type="cylinder")

    # Slope
    tg.AddBox(position=[2.0, 2.0, 0.2],
              euler=[0.0, -0.2, 0.0],
              size=[3, 1.5, 0.01])
